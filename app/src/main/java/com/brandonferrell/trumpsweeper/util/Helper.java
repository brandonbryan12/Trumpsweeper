package com.brandonferrell.trumpsweeper.util;
...
public class Helper {
    ...
    public int getMineResource(boolean explode, boolean flagged) {
        int id = 0;
        ...
        switch (prefs.getString("theme_preference", "default")) {
            case "default":
                if(explode)
                    ...
                    id = R.drawable.trump_mine_flagged;
                else
            ...
            case "default":
                switch (mineCount) {
                    case 0:
                        ...
                        break;
                    case 1:
                        id = R.drawable.trump_cell_1;
                        break;
                    case 2:
                        id = R.drawable.trump_cell_2;
                        break;
                    case 3:
                        id = R.drawable.trump_cell_3;
                        break;
                    case 4:
                        id = R.drawable.trump_cell_4;
                        break;
                    case 5:
                        id = R.drawable.trump_cell_5;
                        break;
                    case 6:
                        id = R.drawable.trump_cell_6;
                        break;
                    case 7:
                        id = R.drawable.trump_cell_7;
                        break;
                    case 8:
                        id = R.drawable.trump_cell_8;
                        break;
                }
                break;
            case "vanilla":
